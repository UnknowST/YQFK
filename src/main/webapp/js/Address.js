var province = [
    ...
    },
    {
        ...
        city: [
            ...
            {
                name: "六盘水市",
                districtAndCounty: ["钟山区", "盘州市", "红果镇", "六枝特区", "平寨镇", "水城县"]
            },
            {
                name: "遵义市",
...
function showCity1(obj) {
    ...
    current_prov = val;
  /*  if (val >=0) {
        city1.style.display = 'inline-block';
...
function showCountry1(obj) {
 ...
 /*   if (val >=0) {
    ...
    if (val != null) {
        ...
        if(countryLen == 0){
            addrShow1.value = province[current_prov].name + '-' + province[current_prov]["city"][val].name;
            return;
        }
        for (var n = 0; n < countryLen; n++) {
            var countryOpt = document.createElement('option');
...
function selectCountry1(obj) {
    current_country1 = obj.options[obj.selectedIndex].value;
    $(".btn").disabled = false;
